...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">TOP 10 Produk Terjual<br>
                    {{-- <div class="row mt-2">
                        <div class="col-4">
                    ...
                    <table class="table">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                ...
                                <td scope="col">{{ $data->price_sell }}</td>
    ...
    <script>
        ...
        $(document).ready(async function () {
            ...
            $.each(data, function (key, value) {
                $('#tbody').append(
                    '   <tr><th scope="row">' + (key + 1) + '</th><td>' + (value['first_name']) + ' ' + value['last_name'] + '</td><td>' + (value['customer'] != null ? value['customer']['address'] != null ? value['customer']['address'] : "-" : "-") + '</td><td>' + (value['phone'] != null ? value['phone'] : "-") + '</td><td><a href="/customers/' + value['id'] + '" class="btn btn-warning">Edit</a></td></tr>'
                );
