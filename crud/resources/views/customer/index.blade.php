...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Customers <br>
                    <div onclick="tambah()" class="btn btn-success">Tambah Data</div>
                    <div class="row mt-2">
                        <div class="col-4">
    ...
    <script>
        ...
        $(document).ready(async function () {
            ...
            $.each(data, function (key, value) {
                $('#tbody').append(
                    '   <tr><th scope="row">' + (key + 1) + '</th><td>' + (value['first_name']) + ' ' + value['last_name'] + '</td><td>' + (value['customer'] != null ? value['customer']['address'] != null ? value['customer']['address'] : "-" : "-") + '</td><td>' + (value['phone'] != null ? value['phone'] : "-") + '</td><td><a href="/customers/' + value['id'] + '" class="btn btn-success">Detail</a></td><td><a onClick=edit('value['id']') class="btn btn-warning">Edit</a></td></tr>'
                );
        ...
        async function render(){
             ...
             await $.ajax({
                url: '/customers/getData?start=' + fromDate + '&end=' + toDate,
                type: "get",
                success: function (result) {
                    data = result.data;
                    form = result.form;
        ...
        function edit(id) {
            $.ajax({
                ...
                success: function (result) {
                    $('#id').val(result['id']);
                    $('#nama').val(result['first_name'] + ' ' + result['last_name']);
                    $('#alamat').val(result['customer'] != null ? result['customer']['address'] != null ? result['customer']['address'] : "-" : "-");
                    $('#phone').val(result['phone'] != null ? result['phone'] : "-");
                    $('.tgl').val(result['created_at']);
                    $('#modal').modal('show');
                } //Change to this
            });
        }
            ...
            await $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(result, function (key, value) {
                        $('#tbody').append(
                            '   <tr><th scope="row">' + (key + 1) + '</th><td>' + (value['first_name']) + ' ' + value['last_name'] + '</td><td>' + (value['customer'] != null ? value['customer']['address'] != null ? value['customer']['address'] : "-" : "-") + '</td><td>' + (value['phone'] != null ? value['phone'] : "-") + '</td><td><a hsref="/cshow/utomers/' + value['id'] + '/edit" class="btn btn-warning">Edit</a></td></tr>'
                        );
                    });
